"""Udeoghjemme staging tests - mobile"""
import pytest
...
def test_accept_all_cookies(page_mobile: Page):
    ...
    page_mobile.goto("https://frontend-stage.udeoghjemme.dk/")
...
def test_load_more_on_category_page(page_mobile: Page):
    ...
    page_mobile.goto("https://frontend-stage.udeoghjemme.dk/skaebner")
    page_mobile.get_by_role("button", name="Tillad alle").click()
...
def test_newsletter_signup(page_mobile: Page):
    ...
    page_mobile.goto("https://frontend-stage.udeoghjemme.dk/nyhedsbrev")
    page_mobile.get_by_role("button", name="Tillad alle").click()
