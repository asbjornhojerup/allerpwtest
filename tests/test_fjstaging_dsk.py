"""Familiejournal staging tests - desktop"""
import pytest
...
def test_accept_all_cookies(page_desktop: Page):
    ...
    page_desktop.goto("https://frontend-stage.familiejournal.dk/")
...
def test_load_more_on_category_page(page_desktop: Page):
    ...
    page_desktop.goto("https://frontend-stage.familiejournal.dk/livshistorier")
    page_desktop.get_by_role("button", name="Tillad alle").click()
...
def test_newsletter_signup(page_desktop: Page):
    ...
    page_desktop.goto("https://frontend-stage.familiejournal.dk/nyhedsbrev")
    page_desktop.get_by_role("button", name="Tillad alle").click()
...
def test_ad_placements_on_frontpage(page_desktop: Page):
    ...
    page_desktop.goto("https://frontend-stage.familiejournal.dk?debugAds=true")
    page_desktop.get_by_role("button", name="Tillad alle").click()
    expect(page_desktop.locator("#responsive_1-1")).to_be_visible()
    page_desktop.evaluate("window.scrollBy(0, 5000)")
