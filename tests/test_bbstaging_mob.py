"""Billedbladet staging tests - mobile"""
import pytest
...
def test_open_menu_go_to_category(page_mobile: Page):
    ...
    page_mobile.goto("https://frontend-stage.billedbladet.dk/")
...
def test_go_to_frontpage_by_clicking_logo(page_mobile: Page):
    ...
    page_mobile.goto("https://frontend-stage.billedbladet.dk/kendte")
    page_mobile.get_by_role("button", name="Tillad alle").click()
...
def test_newsletter_signup(page_mobile: Page):
    ...
    page_mobile.goto("https://frontend-stage.billedbladet.dk/nyhedsbrev")
    page_mobile.get_by_role("button", name="Tillad alle").click()
