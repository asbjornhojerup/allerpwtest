"""Vielskerserier production tests - mobile"""
import pytest
...
def test_accept_all_cookies(page_mobile: Page):
    ...
    page_mobile.goto("https://vielskerserier.dk/")
...
def test_load_more_on_category_page(page_mobile: Page):
    ...
    page_mobile.goto("https://vielskerserier.dk/film/film-nyheder/")
    page_mobile.get_by_role("button", name="Tillad alle").click()
...
def test_ad_placements_on_article(page_mobile: Page):
    ...
    page_mobile.goto(
        "https://vielskerserier.dk/film/film-anmeldelser/anmeldelse-mr-scorsese-er-et-forrygende-portraet-af-en-levende-filmlegende"
    )
    page_mobile.get_by_role("button", name="Tillad alle").click()
    expect(page_mobile.locator("#responsive_1-1")).to_be_visible()
